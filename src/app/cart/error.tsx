    ...
    <div className="min-h-screen bg-cream flex items-center justify-center px-4 py-16">
      <div className="bg-white rounded-3xl shadow-soft p-8 max-w-md w-full text-center">
        <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
          <span className="text-3xl" role="img" aria-label="shopping cart">🛒</span>
        </div>
        <h1 className="font-script text-4xl text-primary mb-1">Something went wrong</h1>
        <p className="font-script text-2xl text-primary/60 mb-6">Error en el carrito</p>
        ...
        <p className="text-gray-500 text-sm mb-6">
          Your cart ran into a problem. Please try again.
          <br />
          <span className="text-gray-400">Tu carrito tuvo un error.</span>
        </p>
