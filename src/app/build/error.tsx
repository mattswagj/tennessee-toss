  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-4 py-16">
      <div className="bg-white rounded-3xl shadow-soft p-8 max-w-md w-full text-center">
        ...
        <p className="font-script text-2xl text-primary/60 mb-6">Error al armar tu ensalada</p>
        ...
        <p className="text-gray-500 text-sm mb-6">
          Your salad builder ran into a problem. Give it another try!
          <br />
          <span className="text-gray-400">El creador de ensaladas tuvo un problema.</span>
        </p>
